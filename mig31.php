...
$stmt=$pdo->prepare(query:"create table blog(id int primary key auto_increment, title varchar(256), text varchar(2048), created_at datetime, updated_at datetime, comments text, views int)");
$stmt->execute();
